...
sudo cp /vagrant/codeupdate/batcountry.py /usr/local/lib/python2.7/dist-packages/batcountry/

sudo cp /vagrant/models/bvlc_googlenet.caffemodel /usr/local/caffe/models/bvlc_googlenet/
